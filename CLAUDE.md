...
- TypeScript 5.1 / React 18.2 + MUI v9 (`@mui/material`, `@mui/icons-material`), Vite 5, Emotion (master)
- `localStorage` via `storageService` — adicionar `purchasedItems` a `CompletedList`; sem nova API (master)
